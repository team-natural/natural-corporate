...
- 決定済み（GOV-01）: D-009 満点比、D-010 参考価格撤去、D-011 外部予約ツール（ツール名未定）、D-012 全体設計先行。
...
- [ ] BIZ-04 / PRD-07 / PRD-09 の結果文章・質問文を事業責任者がレビュー（00_README §8-3「法務表現・対外通知」）
- [ ] GOV-02 §2-6 の P0（TBD-13 / 16 / 17 / 18 / 28）の担当と期限を決める
- [ ] TBD-25 のツール名、TBD-01（Member を使う — 推奨「使う」）を確定
