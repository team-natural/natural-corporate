...
async function finish() {
  ...
  if (token) {
    ...
    const responseId = await saveDiagnosisResponse({ token, diagnosis: slug, definitionVersion: version, answers, clientResult: { resultId: `level-${result.level}`, secondaryResultId: null } });
